INSERT INTO users (name, email, password_hash, avatar, latitude, longitude)
  ...
  ('Wilson Wong', 'wilwong89@gmail.com', '$2a$11$uY8v0HPe9srqEjEV8j7Po.f9xf5DQsLXLaDFT5pr5sm2D03plkQcG', 
  '//www.gravatar.com/avatar/a17548ea579a54c180a7d37a7818501a?s=200&r=pg&d=mm', '48.428', '-123.365');
  ('Jon Langlois', 'jonathan-langlois@live.ca', '$2a$11$Xkr1Hq8QYpCc7QENknqvFuQH01E2gp.5Ze1y.iumUpWPeMlJCBvSG', 
  '//www.gravatar.com/avatar/a17548ea579a54c180a7d37a7818501a?s=200&r=pg&d=mm', '48.428', '-123.365');